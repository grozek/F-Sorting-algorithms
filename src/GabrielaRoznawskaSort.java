 ...
 * CSC-207 MP6 
 * Acknowledgements: 
 * ChatGPT: I asked ChatGPT about some other commonly used algorithms that could serve me as an idea to build
 *         upon. One of his answers was "Bubble Sort", which I liked the name of, so asked for a
 *         bried description of what it is. This algorithm sounded quite simple and friendly so
 *         after this interaction with Chat, I proceeded to write my bubble-sort inspired algorithm.
 */
...
public class GabrielaRoznawskaSort implements Sorter {
  ...
  } // sort(T[], Comparator<? superT>)

  /*
   * While the right and left are within the bounds of the array, compare items on their leftmost,
   * almost leftmost, rightmost and almost rightmost indexes. Move the lower items towards the
   * fornt, and the higher ones towards the back.
   */
